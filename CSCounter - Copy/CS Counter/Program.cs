    ...
    class CsCounter
    {
        ...
        private static void Game_OnGameLoad()
        {
            ...
            CdFrameTexture = Texture.FromMemory(
                    Drawing.Direct3DDevice, (byte[])new ImageConverter().ConvertTo(Resources.Untitled_3, typeof(byte[])), 147,
        ...
        private static void GetCsEnemy()
        {
            foreach (var hero in ObjectManager.Get<Obj_AI_Hero>())
            {
                ...
                Sprite.Draw(CdFrameTexture, new ColorBGRA(255, 255, 255, 255), null, new Vector3(barPos.X, barPos.Y, 0));
